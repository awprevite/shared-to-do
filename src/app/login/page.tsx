      ...
      <div className='flex'>
        ...
        <div className='flex flex-col justify-center items-center gap-2 bg-[var(--dark-accent)] h-screen w-full'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <button className='bg-[var(--light-accent)] p-2 mt-6 mb-2 w-sm rounded-lg transition-transform duration-300 hover:scale-105 cursor-pointer' onClick={ handleAuthenticate }>{state}</button>
            ...
            { state === 'Sign in' ? (
              ...
              <div className='flex justify-start w-full gap-2'>
                ...
                <button className='font-bold' onClick={() => setState('Sign in')}>Sign In</button>
              </div>
            )}
            ...
            <button className='flex justify-center items-center border border-solid border-[var(--fg-color)] p-2 mt-6 mb-2 w-sm rounded-lg transition-transform duration-300 hover:scale-105 cursor-pointer' onClick={ () => alert('Need to implement authenticate with google') }>
